...
export default function DashLayout({children}:{children:React.ReactNode}){
  const items=[["/dashboard","Overview"],["/dashboard/tasks","Request (Auto)"],["/dashboard/github","GitHub (Admin)"],["/dashboard/mcp","MCP Key — Agent Connect"],["/dashboard/builds","Builds"],["/dashboard/tokens","Token Uses"],["/dashboard/tracking","Tracking"],["/dashboard/settings","Settings"]];
