...
export default function DashLayout({children}:{children:React.ReactNode}){
  const items=[["/dashboard","Overview"],["/dashboard/tasks","Requests"],["/dashboard/mcp","Connect Agent"],["/dashboard/tokens","My Coins"],["/dashboard/tracking","Tracking"],["/dashboard/earn","Earn Coins"],["/dashboard/settings","Settings"]];
