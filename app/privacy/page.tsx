export default function Privacy(){
  return (<div className="prose"><div className="page-hero"><div className="kicker" style={{marginBottom:12}}><span className="pulse-dot" />Legal</div><h1>Privacy <span className="grad-anim">Policy</span></h1><p>What we store and how to delete it.</p></div>
